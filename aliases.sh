...
alias php-5.6='docker_alias silvanei/php:5.6-fpm php'
alias composer-5.6='docker_alias silvanei/php:5.6-fpm composer'

alias php-7.0='docker_alias silvanei/php:7.0-fpm php'
alias composer-7.0='docker_alias silvanei/php:7.0-fpm composer'

alias php-7.1='docker_alias silvanei/php:7.1-fpm php'
alias composer-7.1='docker_alias silvanei/php:7.1-fpm composer'

alias php-7.2='docker_alias silvanei/php:7.2-fpm php'
alias composer-7.2='docker_alias silvanei/php:7.2-fpm composer'

alias php-7.3='docker_alias silvanei/php:7.3-fpm php'
alias composer-7.3='docker_alias silvanei/php:7.3-fpm composer'

alias php-7.4='docker_alias silvanei/php:7.4-fpm php'
alias composer-7.4='docker_alias silvanei/php:7.4-fpm composer'

alias php-8.0='docker_alias silvanei/php:8.0-fpm php'
